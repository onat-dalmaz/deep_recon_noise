...
CONFIG_FILE="configs/mri-recon/mridata-3dfse-knee/ssdu-unrolled.yaml"

# Optional variables (commented out)
CALCULATE_PIXEL_VARIANCES=True
...
TEST.CALCULATE_PIXEL_VARIANCES $CALCULATE_PIXEL_VARIANCES \
